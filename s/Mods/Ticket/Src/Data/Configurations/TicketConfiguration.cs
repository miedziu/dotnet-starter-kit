...
namespace FSH.Mods.Ticket.Data.Configurations;

public sealed class TicketConfiguration : IEntityTypeConfiguration<Domain.Ticket>
{
    public void Configure(EntityTypeBuilder<Domain.Ticket> builder)
    {
        ...
        // DeletedAt so soft-deleted ticket numbers don't conflict with new ones.
        builder.HasIndex(x => x.Number).IsUnique().HasFilter("\"DeletedAt\" IS NULL");
