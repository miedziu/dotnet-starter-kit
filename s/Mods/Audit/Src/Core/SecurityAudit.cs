...
public sealed class SecurityAudit : ISecurityAudit
{
    ...
    public ValueTask ImpersonationStartedAsync(string actorUserId, string targetUserId, string clientId, string ip, string userAgent, string reason, CancellationToken ct = default)
    ...
    public ValueTask ImpersonationEndedAsync(string actorUserId, string targetUserId, string clientId, CancellationToken ct = default)
