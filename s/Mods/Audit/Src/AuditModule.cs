...
using FSH.Mods.Audit.Core;
using FSH.Mods.Audit.Data;
using FSH.Mods.Audit.Features.v1;
using FSH.Mods.Audit.Infrastructure.Http;
using FSH.Mods.Audit.Infrastructure.Serialization;
...
public sealed class AuditModule : IModule
{
    public void ConfigureServices(IHostApplicationBuilder builder)
    {
        ...
        FSH.Framework.Shared.Identity.PermissionConstants.Register(Spec.AuditPermissions.All);
