...
using FSH.Mods.Chat.Features.v1.Channels;
using FSH.Mods.Chat.Features.v1.Messages;
using FSH.Mods.Chat.Features.v1.Reactions;
using FSH.Mods.Chat.Features.v1.Search;
using FSH.Mods.Chat.Services;
...
public sealed class ChatModule : IModule
{
    public void ConfigureServices(IHostApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped<FSH.Mods.File.Spec.IFileAccessPolicy, Authorization.ChatChannelFileAccessPolicy>();
