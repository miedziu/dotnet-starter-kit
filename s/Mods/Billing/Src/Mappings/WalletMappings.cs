...
namespace FSH.Mods.Billing.Mappings;
...
internal static class WalletMappings
{
    ...
    public static WalletDto ToDto(this Wallet w, int recentCount = 10)
        => new(
            w.Id, w.Currency, w.Balance.Amount, w.Status.ToString(), w.CreatedAtUtc,
            w.Transactions
    ...
    public static TopupRequestDto ToDto(this TopupRequest r)
        => new(
            r.Id, r.Amount.Amount, r.Amount.Currency, r.Note, r.Status.ToString(),
