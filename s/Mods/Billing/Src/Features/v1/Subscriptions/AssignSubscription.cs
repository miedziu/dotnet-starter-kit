...
using FSH.Mods.Billing.Spec.v1.Subscription;
using Mediator;
...
namespace FSH.Mods.Billing.Features.v1.Subscriptions;
...
#pragma warning restore CA1308
        ...
        var current = await dbContext.Subscriptions
            .FirstOrDefaultAsync(s => s.Status == Spec.SubscriptionStatus.Active, cancellationToken)
