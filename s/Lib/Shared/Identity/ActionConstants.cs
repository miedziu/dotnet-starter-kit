...
public static class ActionConstants
{
    ...
    public const string ManageAll = nameof(ManageAll);
    public const string Send = nameof(Send);
    public const string EditOwn = nameof(EditOwn);
    ...
    public const string ViewTrash = nameof(ViewTrash);
    ...
    public const string RevokeAll = nameof(RevokeAll);
