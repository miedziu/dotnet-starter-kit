...
namespace FSH.Starter.Migrations.PostgreSQL.Billing
{
    ...
    [Migration("20260718231626_InitBilling")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSH.Mods.Billing.Domain.BillingPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Billing.Domain.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Billing.Domain.InvoiceLineItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Billing.Domain.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Billing.Domain.TopupRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Billing.Domain.UsageSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Billing.Domain.Wallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Billing.Domain.WalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Billing.Domain.InvoiceLineItem", b =>
                {
                    b.HasOne("FSH.Mods.Billing.Domain.Invoice", null)
                        .WithMany("LineItems")
                        .HasForeignKey("InvoiceId")
            ...
            modelBuilder.Entity("FSH.Mods.Billing.Domain.WalletTransaction", b =>
                {
                    b.HasOne("FSH.Mods.Billing.Domain.Wallet", null)
