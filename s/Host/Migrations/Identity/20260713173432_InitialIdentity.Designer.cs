...
namespace FSH.Starter.Migrations.PostgreSQL.Identity
{
    ...
    [Migration("20260713173432_InitialIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.FshRole", b =>
                {
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.FshRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.FshUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.GroupRole", b =>
                {
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.ImpersonationGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.PasswordHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.Referral", b =>
                {
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.UserGroup", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.GroupRole", b =>
                {
                    b.HasOne("FSH.Mod.Identity.Domain.Group", "Group")
                        .WithMany("GroupRoles")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FSH.Mod.Identity.Domain.FshRole", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.PasswordHistory", b =>
                {
                    b.HasOne("FSH.Mod.Identity.Domain.FshUser", "User")
            ...
            modelBuilder.Entity("FSH.Mod.Identity.Domain.Referral", b =>
                {
                    b.HasOne("FSH.Mod.Identity.Domain.FshUser", "NewReferredUser")
                        .WithMany()
                    ...
                    b.HasOne("FSH.Mod.Identity.Domain.FshUser", "ReferrerUser")
                        .WithMany("Referrals")
