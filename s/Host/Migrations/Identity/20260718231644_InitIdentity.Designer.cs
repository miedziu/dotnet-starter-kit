...
namespace FSH.Starter.Migrations.PostgreSQL.Identity
{
    ...
    [Migration("20260718231644_InitIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.FshRole", b =>
                {
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.FshRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.FshUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.GroupRole", b =>
                {
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.ImpersonationGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.PasswordHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.Referral", b =>
                {
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.UserGroup", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.GroupRole", b =>
                {
                    b.HasOne("FSH.Mods.Identity.Domain.Group", "Group")
                        .WithMany("GroupRoles")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FSH.Mods.Identity.Domain.FshRole", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.PasswordHistory", b =>
                {
                    b.HasOne("FSH.Mods.Identity.Domain.FshUser", "User")
            ...
            modelBuilder.Entity("FSH.Mods.Identity.Domain.Referral", b =>
                {
                    b.HasOne("FSH.Mods.Identity.Domain.FshUser", "NewReferredUser")
                        .WithMany()
                    ...
                    b.HasOne("FSH.Mods.Identity.Domain.FshUser", "ReferrerUser")
                        .WithMany("Referrals")
