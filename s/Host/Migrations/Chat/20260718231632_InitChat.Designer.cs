...
namespace FSH.Starter.Migrations.PostgreSQL.Chat
{
    ...
    [Migration("20260718231632_InitChat")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSH.Mods.Chat.Domain.ChannelMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Chat.Domain.ChatChannel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Chat.Domain.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Chat.Domain.MessageAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Chat.Domain.MessageMention", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Chat.Domain.MessageReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FSH.Mods.Chat.Domain.ChannelMember", b =>
                {
                    b.HasOne("FSH.Mods.Chat.Domain.ChatChannel", null)
                        .WithMany("Members")
            ...
            modelBuilder.Entity("FSH.Mods.Chat.Domain.MessageAttachment", b =>
                {
                    b.HasOne("FSH.Mods.Chat.Domain.Message", null)
