...
namespace FSH.Starter.Migrations.PostgreSQL.Identity
{
    ...
    [Migration("20260611215619_AddUserReferralTable")]
    partial class AddUserReferralTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSH.Modules.Identity.Domain.Referral", b =>
                {
                    ...
                    b.HasIndex("ReferrerUserId")
                        .IsUnique()
                        .HasDatabaseName("IX_Referrals_ReferrerUserId1");

                    b.HasIndex("ReferralCode", "TenantId")
                        .IsUnique()
                        .HasDatabaseName("IX_Referrals_ReferralCode");

                    b.HasIndex("ReferrerUserId", "TenantId")
                        .IsUnique()
            ...
            modelBuilder.Entity("FSH.Modules.Identity.Domain.Referral", b =>
                {
                    b.HasOne("FSH.Modules.Identity.Domain.FshUser", "ReferredUser")
                    ...
                    b.HasOne("FSH.Modules.Identity.Domain.FshUser", "ReferrerUser")
                        .WithOne("Referral")
                        .HasForeignKey("FSH.Modules.Identity.Domain.Referral", "ReferrerUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
