...
export type { PagedResponse } from "@/api/catalog";
...
/**
 * List tenants without authentication - used for registration.
 * This endpoint is public and returns a simple list of tenant IDs.
 */
export async function listTenantsPublic(): Promise<TenantDto[]> {
  return apiFetch<TenantDto[]>("/api/v1/tenants", { skipAuth: true });
}
